...
letters = 'AÁÀẢÃẠĂẮẰẲẴẶÂẤẦẨẪẬBCDĐEẺẼẸÉÈÊẾỀỂỄỆFGHIÍÌỈĨỊJKLMNOÓÒỎÕỌÔỐỒỔỖỘƠỢỞỠỜỚPQRSTUÚÙỦŨỤƯỨỪỬỮỰVWXYÝỴỲỶỸZaáàảãạăắằẳẵặâấầẩẫậbcdđeẻẽẹéèêếềểễệfghiíìỉĩịjklmnoóòỏõọôốồổỗộơợởỡờớpqrstuúùủũụưứừửữựvwxyýỵỳỷỹz0123456789/- '
MAX_LEN = 70
SIZE = 2080, 160
...
class TextImageGenerator:
    def __init__(self, img_dirpath, labels_path, img_w, img_h,
        ...
        self.labels= json.load(open(labels_path,encoding='utf-8')) if labels_path != None else None
